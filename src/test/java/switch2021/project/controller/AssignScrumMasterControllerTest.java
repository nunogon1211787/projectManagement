...
class AssignScrumMasterControllerTest {
    ...
    public void controllerTest() {
        ...
        App.getInstance().getCompany().getProjectStore().saveNewProject(proj1);
        //Act
        Company company = new Company();
        company.getProjectStore().saveNewProject(proj1);
        //Assert
        assertEquals(company.getProjectStore().getProjectByCode("proj_2022_1"), controller.getProject("proj_2022_1"));
    }
    ...
    void assignScrumMasterTestSuccess() {
       ...
       // Resource manuelfernandes =proj1.getProjectTeam.c(user5, startDateMf, endDateMf, 100, 1);
