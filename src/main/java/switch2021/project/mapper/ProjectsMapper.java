...
public class ProjectsMapper {
    ...
    public ProjectDTO toDTO(Project project) {
        ...
        return new ProjectDTO(project.getCode().getCode(), project.getProjectName().getText(),
                startDate, endDate);
    }
    ...
    public List<ProjectDTO> toDtoByUser(List<Project> projectListByUser) {
        ...
        for (Project project : projectListByUser) {
            ProjectDTO projectListByUserDto = new ProjectDTO(project.getCode().getCode(), project.getProjectName().getText(), project.getDescription().getText());
