...
public class ManageResourcesService {
    ...
    public boolean resourceCreationValidation(LocalDate startDate, LocalDate endDate, List<ResourceReeng> projectTeam, List<ResourceReeng> resourceProjectsList){
...
//            if (res.getRole().isEqual(projectRole) && res.isActiveToThisDate(startDate) && res.isActiveToThisDate(endDate)) {
//                sum = sum + res.getAllocation().getPercentage();
//            }
//        }
//        if ((sum + allocation.getPercentage()) <= 1) {
