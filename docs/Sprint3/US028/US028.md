...
Director has access to all projects in the system. The human resources associated with the project is saved in the class named Project Team.
To get the list Director must tell which project, knowing the project code, he wants to get the human resources.
